...
WebUI.setText(findTestObject('Object Repository/TC120012/input_Address type HomeOffice_zip'), '12410')

WebUI.verifyElementNotPresent(findTestObject('TC120001/div_User is successfully Register. Now You _baeefb'), 0)

WebUI.click(findTestObject('Object Repository/TC120012/input'))
