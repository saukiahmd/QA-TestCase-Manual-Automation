...
WebUI.click(findTestObject('Object Repository/TC120009/input_Address type HomeOffice_add_type'))

WebUI.click(findTestObject('Object Repository/TC120009/input'))
