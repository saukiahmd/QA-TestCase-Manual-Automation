...
WebUI.selectOptionByValue(findTestObject('Object Repository/TC120010/select_Choose Gender                  Male _4c15ff'), 
    '1', true)

WebUI.verifyElementNotPresent(findTestObject('TC120001/div_User is successfully Register. Now You _baeefb'), 0)

WebUI.click(findTestObject('Object Repository/TC120010/input'))
