...
WebUI.setText(findTestObject('Object Repository/1.2. Employees - Edit Employees - Bank Account/input'), 'nadine amizah')
...
WebUI.verifyElementPresent(findTestObject('1.2. Employees - Edit Employees - Bank Account/label_Please enter at least 5 characters'), 
    0)
