...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/1.2. Employees - Edit Employees - Bank Account/div_Successfully Added'), 
        0)) {
	KeywordUtil.markError('Berhasil merubah data bank account')
	WebUI.closeBrowser()
}
